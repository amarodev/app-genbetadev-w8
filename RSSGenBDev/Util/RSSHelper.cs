...
namespace RSSGenBDev.Util
{
    public static class RSSHelper
    {
        ...
        {
            //return null;
            var synClient = new SyndicationClient();
            var lista = new ArticleList();
            var feed = await synClient.RetrieveFeedAsync(new Uri(feedUrl));
        ...
        /// <remarks>This method uses regular expressions,so using System.Text.RegularExpressions; must be added</remarks>
